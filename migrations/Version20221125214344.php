 ...
 */
final class Version20221125214344 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image ADD CONSTRAINT FK_C53D045F3571693E FOREIGN KEY (relation_image_plant_id) REFERENCES plant (id)');
